...
const ERROR_MESSAGES = {
  ...
  google_no_email: "Could not retrieve your email from Google. Please use email/password.",
  github_no_email: "Your GitHub email is private. Please make it public or use email/password.",
        ...
        <form onSubmit={onSubmit} className="mt-6 space-y-4 rounded-lg border bg-white p-6 shadow">
          {(err || oauthError) && (
            <p className="text-sm text-red-600">
              {err || ERROR_MESSAGES[oauthError] || "Authentication failed. Please try again."}
            </p>
          )}
